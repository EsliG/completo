				...
				<td class="td" width="60%" valign="top">
					<div class="flotanteSede">
						...
						<div class="titulosucursales" style="position: relative;">
							Olímpica<span class="nuevap">Nueva</span>
						</div>
						<p class="sucursalinflocali" onclick="location.href='/SedeOlimpica';">
							Calle Violeta, #1441,<br>Col. Olímpica,<br>Guadalajara, Jalisco
						</p>
						<img src="img/sidebar/telefono.png" onclick="location.href='tel:33 2687 2937';" class="imflotantesuc">
						<img src="img/logos/ubi.png" onclick="location.href='https://goo.gl/maps/FCjSvPQspsWN8y2u5';" class="imflotantesuc">
						<img src="img/sidebar/whatsapp.png" onClick="hrefwhatsapp2()" class="imflotantesuc">
						</div>
					</div>
					<div class="flotanteSede">
						<div  class="contenidosedesceuni">
						...
						Av. Manuel Ávila Camacho #1402-A Entrada Por  Calle 6 De Diciembre. San Miguel de Mezquitan. Guadalajara Jal. C.P 44260
						</p>
						<img src="img/sidebar/telefono.png" onclick="location.href='tel:33 2300 3952';" class="imflotantesuc">
						<img src="img/logos/ubi.png" onclick="location.href='https://www.google.com.mx/maps/place/Av.+Manuel+%C3%81vila+Camacho+1402-a,+San+Miguel+de+Mezquitan,+44260+Guadalajara,+Jal./@20.7005248,-103.3585735,17z/data=!3m1!4b1!4m5!3m4!1s0x8428b1d785b4a8b7:0x1b79bbf0c00eef2e!8m2!3d20.7005248!4d-103.3563848" class="imflotantesuc">
					...
					<div class="flotanteSede">
						...
						<p class="sucursalinflocali" onclick="location.href='/SedeCruzdelSur';">
					...
					<div class="flotanteSede">
						...
						<p class="sucursalinflocali" onclick="location.href='/SedeLaEstancia';">
					...
					<div class="flotanteSede">
						...
						<p class="sucursalinflocali" onclick="location.href='/SedePatria';">
					...
					<div class="flotanteSede">
						...
						<p class="sucursalinflocali" onclick="location.href='/SedeTorreSur';">
...
function initMap() {
    ...
    var markers = [
        ['Corporativo Zapopan', 20.7005248, -103.3585735],
    ...
    var infoWindowContent = [
        ...
        '<p>Av. Manuel Ávila Camacho #1402-A Entrada Por  Calle 6 De Diciembre. San Miguel de Mezquitan. Guadalajara Jal. C.P 44260 </p><br> <a href="https://www.google.com.mx/maps/place/Av.+Manuel+%C3%81vila+Camacho+1402-a,+San+Miguel+de+Mezquitan,+44260+Guadalajara,+Jal./@20.7005248,-103.3585735,17z/data=!3m1!4b1!4m5!3m4!1s0x8428b1d785b4a8b7:0x1b79bbf0c00eef2e!8m2!3d20.7005248!4d-103.3563848" target="_blank">Ver en Google Maps</a>' + '</div>'],
		 ['<div class="info_content">' +
        '<h3>Cruz del Sur</h3>' +
...
document.querySelectorAll('a[href^="tel"]').forEach(function(el){el.addEventListener('click', function(e){
	alert("telefono");
    gtag('event', 'click', {
...
document.querySelector('body > div.icon-barslide > a.whatsapp').addEventListener('click', function(e){
    gtag('event', 'click', {
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCK1bV5XdpmHyXQ_162stOcCflY98g0uBc&callback=initMap" async defer></script>
