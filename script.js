...
var Tracker = Vue.extend({
  ...
  <span v-show="show" class="flip-clock__piece">
    ...
    <span class="flip-clock__slot">
	    <span v-if="property === 'Days'">
			Dias
		</span>
 		<span v-if="property === 'Hours'">
			Horas
		</span>
 		<span v-if="property === 'Minutes'">
			Minutos
		</span>
 		<span v-if="property === 'Seconds'">
			Segundos
		</span>
	</span>
  </span>`,
  props: ['property', 'time','propiedades'],
  data: () => ({
    current: 0,
    previous: 0,
    show: false }),
...
var Countdown = new Vue({
  ...
  template: ` 
  <div class="flip-clock" data-date="2019-11-09 09:00:00" @click="update">
    <tracker 
  ...
  data: () => ({
	...
	titulos: ['Dias','Horas','Minutos','Segundos']
  }),
  ...
  methods: {
    ...
    setCountdown(date) {
      ...
      if (date) {
        ...
        this.countdown = moment("2019-11-09 09:00:00", 'YYYY-MM-DD HH:mm:ss'); //this.$el.getAttribute('data-date');
      }
    },
