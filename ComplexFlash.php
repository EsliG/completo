...
<?php
	...
	//variablesinerseman 
	$Int_total_de_semanas="2";
	$Int_fecha_de_inicio = "28 de octubre";
	$Int_fecha_de_termino = "08 de noviembre";
	$Int_horas_diarias = "4";
	$Int_total_de_horas = "40";
	$Int_precio_curso = 3490;
	$Int_horario_matutino = "08:00 - 12:00";
	$Int_horario_vespertino = "16:00 - 20:00";
	
	//primerdeeuntgo
	$fechaprimerpagointer1 = "15 de octubre";
	$fechaultimopagointer1 = "21 de octubre";
	$descuentointer1 = round(sacardescuento($Int_precio_curso,$descuento1));
	$descuentodiezinter1 = round(sacar10mas($descuentointer1));
	//segundodescuento
	$fechaprimerpagointer2 = "15 de octubre";
	$fechaultimopagointer2 = "18 de octubre";
	$descuentointer2 = round(sacardescuento($Int_precio_curso,$descuento2));
	$descuentodiezinter2 = round(sacar10mas($descuentointer2));
	//stercerdescuento
	$fechaprimerpagointer3 = "15 de octubre";
	...
	$numerodeseansfines="3 SÁBADOS o DOMINGOS";
	$fechainicofinesseman = "19 de octubre";
	$fechaterminofinesseman = "02 de noviembre";
	$numerodehorasfines = "5";
	$nuemrodehorasdiasfines = "15";
	$Fines_precio_curso = 1290;
	$horariosmattinofines = "<b class='infotexatricurcurspo'>SÁBADOS</b> : 09:00-14:00 / 14:00-19:00";
	$horariosvespnofines = "15:00-17:00";
	
	//primerdeeuntgo
	$fechaprimerpagofines1 = "15 de octubre";
	$fechaultimopagofines1 = "19 de octubre";
	$descuentofines1 = round(sacardescuento($Fines_precio_curso,$descuento1));
	$descuentodiezfines1 = round(sacar10mas($descuentofines1));
	//segundodescuento
	$fechaprimerpagofines2 = "15 de octubre";
	$fechaultimopagofines2 = "19 de octubre";
	$descuentofines2 = round(sacardescuento($Fines_precio_curso,$descuento2));
	$descuentodiezfines2 = round(sacar10mas($descuentofines2));
	//stercerdescuento
	$fechaprimerpagofines3 = "15 de octubre";
	$fechaultimopagofines3 = "26 de octubre";
	...
	<table class="tablecurses" width="60%">
		<tr>
			<td valign="middle" width="100%" style="text-align: center;">
				<img class="logoscursos" src="img/logos/complexflashcurso.png">
				<span class="texttitulocursos">Complex Flash</span>
			</td>
		</tr>
	</table>
	</div>
...
<div style="position: relative;">
    ...
    border-collapse: collapse;">
			<tr>
				<td onClick="interdiv()" width="50%" id="divintersem" class="selectexpaa">
					Intersemanal
				</td>
				<td onClick="finesdiv()" width="50%" class="intermoduexpaa" id="divfinessem" style="display: none;">
					Fines de Semana
				</td>
			</tr>
		</table>
...
Comprometido con tu educación superior, CE UNI pone a tu disposición una sede cerca de ti, donde podrás cursar nuestro sistema de capacitación avanzado en un espacio adaptado para tu mayor comodidad, equipado con tecnología de apoyo para proporcionarte el entrenamiento apropiado en las áreas de instrucción exigidas en la PAA y de este modo lograr tu máximo aprovechamiento. Todas nuestras sedes cuentan con pantallas y/o proyectores, mismos que serán utilizados por tu profesor Master Training, como herramienta del método de entrenamiento “COACHING” y así lograr un mayor acercamiento e interacción con los alumnos.
		...
		<table class="table" role="table" width="100%" style="border-collapse: collapse; display: none;">
			<tbody class="tbody" role="rowgroup">
				<tr class="tr" role="row">
				...
				<tr class="tr" role="row">
					<td valign="top" class="td" width="20%" style="background: #eeeeee;">
						<table id="tablecursatri1" class="infoatritableslect" onClick="atributo1()">
							<tr>
								<td class="infoatribu">
									<img class="infoatriimg" src="img/logos/atributos/expaa/expaa1.png">
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha1" class="lgmedcurs" src="img/logos/atributos/expaa/minus.png">
												</td>
											</tr>
										</table>
									</div>
					...
					<td valign="top" class="td" width="20%" style="background: #eeeeee;">
						<table id="tablecursatri2" class="infoatritable" onClick="atributo2()">
							<tr>
								<td class="infoatribu">
									<img class="infoatriimg" src="img/logos/atributos/expaa/expaa2.png">
									<p class="infotexatricurdes">
										TEMAS IMPARTIDOS
									</p>
								</td>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha2" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
								...
								<table class="table" role="table" width="100%" style="border-collapse: collapse;">
									<tbody class="tbody" role="rowgroup">
										<tr class="tr" role="row">
											...
											<div style="text-align: left;">
												<div class="infotexatricurdiv">
													<b class="infotexatricurcurspo">Inglés:</b><br><span class="subinfocursdiv">Identificarás tu nivel de competencia lingüística: básico, intermedio y avanzado. Podrás, de este modo, medir tu conocimiento en el uso del idioma, a través de la comprensión de lectura y destrezas de redacción evaluadas indirectamente. En síntesis, una adaptación completa al formato de la sección de inglés de la PAA. </span><br>
												</div>
											</div>
											</td>
										</tr>
					...
					<td valign="top" class="td" width="20%" style="background: #eeeeee;">
						<table id="tablecursatri3" class="infoatritable" onClick="atributo3()">
							<tr>
								<td class="infoatribu">
									<img class="infoatriimg" src="img/logos/atributos/expaa/expaa3.png">
									<p class="infotexatricurdes">
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha3" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
					...
					<td valign="top" class="td" width="20%" style="background: #eeeeee; display: none"><!--Display-->
						<table id="tablecursatri4" class="infoatritable" onClick="atributo4()">
							<tr>
								<td class="infoatribu">
									<img class="infoatriimg" src="img/logos/atributos/expaa/expaa4.png">
									<p class="infotexatricurdes">
										MATERIAL DIDACTICO
									</p>
								</td>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha4" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
									...
									<tbody class="tbody" role="rowgroup">
										<tr class="tr" role="row">
											...
											<div style="text-align: left;">
												...
												<div class="infotexatricurdiv">
													<b class="infotexatricurcurspo">1 Manual Inglés:</b><br>
													<span class="subinfocursdiv">
											...
											<div style="text-align: left;">
												...
												<div class="infotexatricurdiv">
													<b class="infotexatricurcurspo">5 Exámenes simulacro:</b><br>
													<span class="subinfocursdiv">
		Nuestros exámenes exclusivos son adaptados a la forma de aplicación de la PAA; contienen la misma cantidad de ejercicios, grado de dificultad similar o superior y tiempos establecidos para cada módulo.
					...
					<td valign="top" class="td" width="20%" style="background: #eeeeee;">
						<table id="tablecursatri5" class="infoatritable" onClick="atributo5()">
							<tr>
								<td class="infoatribu">
									<img class="infoatriimg" src="img/logos/atributos/expaa/expaa5.png">
									<p class="infotexatricurdes">
										MASTER TRAINING
									</p>
								</td>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha5" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
		...
		<script>
			function atributo1(){
				if(document.getElementById("divinfoatri1").style.display=="block"){
					...
					if(w2<940){
						...
						document.getElementById("flecha1").src="img/logos/atributos/expaa/plus.png";
					...
					document.getElementById("flecha1").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo2(){
				if(document.getElementById("divinfoatri2").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri2").style.display="none";
						document.getElementById("flecha2").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri2").classList.add("infoatritable");
					document.getElementById("tablecursatri2").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha2").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo3(){
				if(document.getElementById("divinfoatri3").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri3").style.display="none";
						document.getElementById("flecha3").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri3").classList.add("infoatritable");
					document.getElementById("tablecursatri3").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha3").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo4(){
				if(document.getElementById("divinfoatri4").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri4").style.display="none";
						document.getElementById("flecha4").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri4").classList.add("infoatritable");
					document.getElementById("tablecursatri4").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha4").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo5(){
				if(document.getElementById("divinfoatri5").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri5").style.display="none";
						document.getElementById("flecha5").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri5").classList.add("infoatritable");
					document.getElementById("tablecursatri5").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha5").src="img/logos/atributos/expaa/minus.png";
...
<center>
	<span class="texsistematitulo" style="color: #8e6a0c;">Nuestras Sedes</span>
</center>
<div style="padding-top: 50px; padding-bottom: 0%; width: 100%;">
	<!--<div class="servidordesede2">
		<a href="SedeOlimpica">
			<div class="divinicursoservicios2" style="background-image: url('img/sedes/olimpica/index.png'); position: relative;">
			<img src="img/logos/letreronuevo.png" class="floranteletreronueva">
				
			<div style="width: 100%; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
				<table class="tablecurses" style="width: 80%;">
					<tr>
			<td valign="middle" width="100%" style="text-align: center;">
				<img src="img/sedes/olimpica/iconblan.png" width="60%"><br>
				<span class="subtexpago">Olímpica</span>
			</td>
		</tr>
				</table>
			</div>
				...
				<table class="table" role="table" width="80%" style="border-collapse: collapse;">
					...
					<td valign="top" class="td" width="33%">
						<div class="paddinpres">
							<div class="expaaapago1">
							<div class="tituexpaadidiv">
								ANTICIPADO 
							</div>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha1fin" class="lgmedcurs" src="img/logos/atributos/expaa/minus.png">
												</td>
											</tr>
										</table>
									</div>
								...
								<table class="table" role="table" width="100%" style="border-collapse: collapse;">
									<tbody class="tbody" role="rowgroup">
										<tr class="tr" role="row">
											...
											<div style="text-align: left;">
												<div class="infotexatricurdiv">
													<b class="infotexatricurcurspo">Matutino:</b><span class="subinfocursdiv">&nbsp;<?php echo $horariosmattinofines;?></span><br>
												</div>
												<div class="infotexatricurdiv">
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha2fin" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha3fin" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha4fin" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
									...
									<tbody class="tbody" role="rowgroup">
										<tr class="tr" role="row">
											...
											<div style="text-align: left;">
												...
												<div class="infotexatricurdiv">
													<b class="infotexatricurcurspo">3 Exámenes simulacro:</b><br>
													<span class="subinfocursdiv">
		Nuestros exámenes exclusivos son adaptados a la forma de aplicación de la PAA; contienen la misma cantidad de ejercicios, grado de dificultad similar o superior y tiempos establecidos para cada módulo.
													</span><br>
												</div>
									...
									<div class="subtexmovatrides">
										<table width="100%">
											<tr>
												...
												<td width="20%">
													<img id="flecha5fin" class="lgmedcurs" src="img/logos/atributos/expaa/plus.png">
												</td>
											</tr>
										</table>
									</div>
		...
		<script>
			function atributo1fin(){
				if(document.getElementById("divinfoatri1fin").style.display=="block"){
					...
					if(w3<940){
						...
						document.getElementById("flecha1fin").src="img/logos/atributos/expaa/plus.png";
					...
					document.getElementById("flecha1fin").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo2fin(){
				if(document.getElementById("divinfoatri2fin").style.display=="block"){
					...
					if(w3<940){
						document.getElementById("divinfoatri2fin").style.display="none";
						document.getElementById("flecha2fin").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri2fin").classList.add("infoatritable");
					document.getElementById("tablecursatri2fin").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha2fin").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo3fin(){
				if(document.getElementById("divinfoatri3fin").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri3fin").style.display="none";
						document.getElementById("flecha3fin").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri3fin").classList.add("infoatritable");
					document.getElementById("tablecursatri3fin").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha3fin").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo4fin(){
				if(document.getElementById("divinfoatri4fin").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri4fin").style.display="none";
						document.getElementById("flecha4fin").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri4fin").classList.add("infoatritable");
					document.getElementById("tablecursatri4fin").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha4fin").src="img/logos/atributos/expaa/minus.png";
			...
			function atributo5fin(){
				if(document.getElementById("divinfoatri5fin").style.display=="block"){
					...
					if(w2<940){
						document.getElementById("divinfoatri5fin").style.display="none";
						document.getElementById("flecha5fin").src="img/logos/atributos/expaa/plus.png";
						document.getElementById("tablecursatri5fin").classList.add("infoatritable");
					document.getElementById("tablecursatri5fin").classList.remove("infoatritableslect");
					}
				}
				else{
					document.getElementById("flecha5fin").src="img/logos/atributos/expaa/minus.png";
...
<div style="padding-top: 3%; padding-bottom: 0%; width: 100%;">
	<div class="servidordesede2">
		<a href="SedePatria">
			<div class="divinicursoservicios2" style="background-image: url(img/sedes/patria/index.png);">
			<div style="width: 100%; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
				<table class="tablecurses" style="width: 80%;">
					<tr>
			<td valign="middle" width="100%" style="text-align: center;">
				<img src="img/sedes/patria/logo.png" width="60%"><br>
				<span class="subtexpago">Patria</span>
			</td>
		</tr>
				</table>
			</div>
	...
	<div class="servidordesede">
		<a href="SedeCruzdelSur">
			<div class="divinicursoservicios2" style="background-image: url(img/sedes/cruzdelsur/index.png);">
			<div style="width: 100%; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
				<table class="tablecurses" style="width: 80%;">
					<tr>
			<td valign="middle" width="100%" style="text-align: center;">
				<img src="img/sedes/cruzdelsur/icono.png" width="60%"><br>
				<span class="subtexpago">Cruz del Sur</span>
			</td>
		</tr>
				</table>
			</div>
	...
	<div class="servidordesede">
		<a href="SedeLaEstancia">
			<div class="divinicursoservicios2" style="background-image: url(img/sedes/laestancia/inicio.jpg);">
			<div style="width: 100%; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
				<table class="tablecurses" style="width: 80%;">
					<tr>
			<td valign="middle" width="100%" style="text-align: center;">
				<img src="img/sedes/laestancia/iconblan.png" width="60%"><br>
				<span class="subtexpago">La Estancia</span>
			</td>
		</tr>
				</table>
			</div>
	...
	<div class="servidordesede">
		<a href="SedeTorreSur">
			<div class="divinicursoservicios2" style="background-image: url(img/sedes/torresur/index.png);">
			<div style="width: 100%; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
				<table class="tablecurses" style="width: 80%;">
					<tr>
			<td valign="middle" width="100%" style="text-align: center;">
				<img src="img/sedes/torresur/logo.png" width="60%"><br>
				<span class="subtexpago">Torre Sur</span>
			</td>
		</tr>
				</table>
			</div>
...
if($v1 =="Intersemana"){
	echo "
	 ...
	 document.getElementById('finesdesemana').style.display = 'none';
	 	document.getElementById('divintersem').classList.remove('intermoduexpaa');
		document.getElementById('divintersem').classList.add('selectexpaa');
		document.getElementById('divfinessem').classList.remove('selectexpaa');
		document.getElementById('divfinessem').classList.add('intermoduexpaa');
    </script>
	 ";
	}
	if($v1 =="FinesdeSemana"){
	echo "
	 ...
	 document.getElementById('divfinessem').classList.remove('intermoduexpaa');
	 document.getElementById('divfinessem').classList.add('selectexpaa');
		document.getElementById('divintersem').classList.remove('selectexpaa');
		document.getElementById('divintersem').classList.add('intermoduexpaa');
    </script>
	 ";
	}
