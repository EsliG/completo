...
<body>
	...
	$Int_total_de_semanas = "5";
	$Int_fecha_de_inicio = "11 de octubre";
	$Int_fecha_de_termino = "12 de noviembre";
	$Int_horas_diarias = "2";
	$Int_cantidad_examenes_simulacro = "5";
	$Int_total_de_horas = "50";
	$Int_precio_curso = 6190;
	$Int_horario_matutino = "11:00 - 13:00";
	$Int_horario_vespertino = "17:00 - 19:00";

	//---------------------------------------------------------------NO TOCAR-------------------------------------------------------------//
	//primerdeeuntgo
	$fechaprimerpagointer1 = $fechadedescuento;
	$fechaultimopagointer1 = "11 de octubre";
	...
	$fechaultimopagointer2 = "15 de octubre";
	...
	$fechaultimopagointer3 = "15 de Octubre";
	...
	$Fines_total_de_semanas = "5 SÁBADOS";
	$Fines_fecha_de_inicio = "09 de Octubre";
	$Fines_fecha_de_termino = "06 de noviembre";
	$Fines_horas_diarias = "5";
	$Int_cantidad_examenes_simulacrofines = "4";
	$Fines_total_de_horas = "25";
	$Fines_precio_curso = 5390;
	$Fines_horario_matutino = ": 09:00 - 14:00";
	$Fines_horario_vespertino = " ";

	//primerdeeuntgo
	$fechaprimerpagofines1 = $fechadedescuento;
	$fechaultimopagofines1 = "09 de Octubre";
	...
	<div class="divinicurso" style="background-image: url('img/slider/administracion.png');">
		<div style="width: 100%;
  text-align: center;
  position: absolute;
  top: 50%;
  ...
  transform: translate(-50%, -50%);">
			<table class="tablecurses" width="60%">
				<tr>
					<td valign="middle" width="100%" style="text-align: center;">
						<img class="logoscursos" src="img/logos/perfexpl.png">
						<span class="texttitulocursos">Perfex</span>
					</td>
				</tr>
			</table>
		</div>
    ...
    border-collapse: collapse;">
				<tr class="botones_luis">
					<td onClick="location.href='/Perfex'" width="50%" id="divintersem" class="selectmedic">
						Intersemanal
					</td>
					<td onClick="location.href='Perfex?Curso=FinesdeSemana'" width="50%" class="intermodcemedic" id="divfinessem">
						Fines de Semana
					</td>
				</tr>
			</table>
					...
					<tbody class="tbody" role="rowgroup">
						<tr class="tr" role="row">
							<td valign="top" class="td" width="50%">
								<div class="texinitexdiv">
									<p class="texnegbody">
									"Curso ideal para aspirantes a carreras Lic. en Negocios internacionales, Lic. en Contabilidad, Lic. en Mercadotecnia, Lic. en Diseño Industrial, Lic. en Biología, Lic. en Nutrición, Lic. en Psicología, Lic. en Químico Farmacéutico Biólogo y todas aquellas de ALTA DEMANDA. Para tu capacitación, desarrollamos un sistema de entrenamiento avanzado teórico-práctico con el cual podrás incrementar tus habilidades de lectura y razonamiento Matemático, de forma EXPONENCIAL y contarás con Examenes Simlacro de prueba con ejercicios de dificultad similar o superior a los que contiene la PAA con los que pondrás a prueba tu capacitación de manera constante como el universitario que eres. Para asegurarnos de tu buen resultado y brindarte una atención personalizada, nuestros grupos están reducidos a máximo 12 alumnos." 
									</p>
								</div>
