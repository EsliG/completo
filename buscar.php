...
Queremos que logres tu puntaje , por lo cual te queremos ofrecer un descuento especial y que nos contactes en el 
		
		<div id='medicos".$id."' onclick='enviarformulariofer()' style='display:block;color:#F6323E;'>
			Siguiente Enlace 
		</div>
		<div id='altospuntajes".$id."' onclick='enviarformulariofer()' style='display:block;color:#F6323E;'>
			Siguiente Enlace
		</div>
		<div id='unextraining".$id."' onclick='enviarformulariofer()' style='display:block;color:#F6323E;'>
			Siguiente Enlace
		</div>
		<div id='unex".$id."' onclick='enviarformulariofer()' style='display:block;color:#F6323E;'>
			Siguiente Enlace
		</div>
